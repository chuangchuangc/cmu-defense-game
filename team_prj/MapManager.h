...
protected:
	loc tower1_loc = { 900, 200 }, tower2_loc = { 1050, 200 };
	loc upgrade_loc = { 870, 650 }, remove_loc = { 1030, 650 }, back_loc = { 950, 650 };
	GLuint texture_menu, texture_coin, texture_tower1, texture_tower2, texture_upgrade, texture_remove, texture_back;
	...
	void GLSetup(const char menufn[], const char coinfn[], const char tower1fn[], const char tower2fn[], const char upgradefn[], const char removefn[], const char backfn[]);

public:
	MenuManager(const char menufn[] = "menu.png", const char coinfn[] = "money.png", const char tower1fn[] = "tower1.png", const char tower2fn[] = "tower2.png", const char upgradefn[] = "Upgrade.png", const char removefn[] = "Remove.png", const char backfn[] = "Back.png") {
		GLSetup(menufn, coinfn, tower1fn, tower2fn, upgradefn, removefn, backfn);
		prev_time = time(NULL);
	}
